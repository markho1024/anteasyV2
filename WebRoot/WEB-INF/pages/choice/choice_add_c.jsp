...
<script type="text/javascript">
	$(function() {
		$("#ctrlBack").bind("click", function() {
			window.location.href = "<%=request.getContextPath()%>/ChcE_listC.action?currentPage=1";
						});
         $("#ctrlLoad").bind("click",function(){
			...
			var errWords=null;
			if(voc!=null&&voo!=null&&voc!=''&&voo!=''&&vos!=null&&vos!=''){
			     $.ajax({ 
				       type: "post", 
 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			...
			<div class="addtable">
				<form action="ChcE_saveC" id="saveForm">
					...
					<ul class="maintable">
						...
						<li>
							...
							<div class="maintd">
								...
								<div class="inputtxt">请输入合格的学生号（十位纯数字）<a href="<%=request.getContextPath()%>/StdE_listC.action?soStudent=&startDate=&endDate=" target="_blank">查找学生</a></div>
							</div></li>
						...
						<li>
							...
							<div class="maintd">
								...
								<div class="inputtxt">请输入合格的课程号（七位纯数字）<a href="<%=request.getContextPath()%>/CrsE_listC.action?soCourse=&startDate=&endDate=" target="_blank">查找课程</a></div>
							</div></li>
						...
						<li>
							...
							<div class="maintd">
								...
								<div class="inputtxt">请输入合格的课序号（小于四位纯数字）<a href="<%=request.getContextPath()%>/OpnE_listC.action?soOpen=&startDate=&endDate=&lowCredit=&highCredit=" target="_blank">查找开课</a></div>
							</div></li>
