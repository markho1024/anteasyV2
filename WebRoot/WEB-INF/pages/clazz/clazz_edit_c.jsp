...
<script type="text/javascript">
	$(function() {
		$("#ctrlBack").bind("click", function() {
			window.location.href = "<%=request.getContextPath()%>/ClzE_listC.action?currentPage=1";
						});
	...
	$(function() {
		$("#COLLEGE_ID_S").combotree({
			...
			onChange:function(){
					...
					var url= "./MjrJ_comboP?jsonType=&jsonValue="+voc;
 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			<div class="navTittle">
				<h2>学院综合管理—> 班级管理—> 修改班级</h2>
			</div>
			<div class="addtable">
				<form action="ClzE_updateC" id="saveForm">
					...
					<ul class="maintable">
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="clazz.clazzID" id="CLAZZ_ID" maxlength="64" readonly="readonly" class="disinput" value="${clazz.clazzID}">
									</span>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="clazz.clazzName" id="CLAZZ_NAME"
											maxlength="64" value="${clazz.clazzName}">
									</span>
									<span class="errs"></span>
								</div>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text"  id="COLLEGE_ID_S"
											maxlength="64" value="${clazz.collegeID}">
									</span>
									<span class="errs"></span>
								</div>
							</div></li>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text"  id="MAJOR_ID_S"
											maxlength="64" value="${clazz.majorID}">
									</span>
									<span class="errs"></span>
								</div>
							</div></li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="radio"><s:radio
											list="#{'1':'正常','91':'已取消'}" name="clazz.status"
											theme="simple" value="#{clazz.status}" /></span>
								</div>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input">
										<textarea name="clazz.remark" id="REMARK" rows="7" cols="32">${clazz.remark}</textarea>
									</span>
									<span class="errs"></span>	
								</div>
