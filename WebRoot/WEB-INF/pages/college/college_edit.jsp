 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			<div class="navTittle">
				<h2>院系综合管理—> 院系管理—> 修改院系</h2>
			</div>
			<div class="addtable">
				<form action="Clg_update" id="saveForm">
					<p class="title">院系资料</p>
					<ul class="maintable">
						<li>
							<div class="mainth">
								<span class="red">*</span>院系号：
							</div>
							<div class="maintd">
								<div class="inputbox">
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="college.collegeName"
											id="COLLEGE_NAME" maxlength="64" value="${college.collegeName}">
									</span>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="radio"><s:radio list="#{'1':'正常','91':'已取消'}" name="college.status" theme="simple" value="#{college.status}" /> </span>
								</div>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input">
										<textarea name="college.remark" id="REMARK" rows="7" cols="32">${college.remark}</textarea>
									</span>
									<span class="errs"></span>
								</div>
