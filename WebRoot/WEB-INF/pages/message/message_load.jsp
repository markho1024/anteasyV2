				...
				<form action="Msg_update">
					...
					<ul class="maintable">
						...
						<li>
							...
							<div class="maintd">
								<div class="playbox">
									<span class="words"><a:dict type="message" code="message.isRead"/></span>
								</div>
							</div></li>
						...
						<li>
							...
							<div class="maintd">
								<div class="playbox">
									<span class="words"><a:dict type="message" code="message.isReply"/></span>
								</div>
							</div></li>
						...
						<s:if test="message.isRead!=1">
							...
							<div class="maintd">
								<div class="playbox">
									<span class="words"><s:date name="message.readDate" format="yyyy-MM-dd"/></span>
								</div>
							</div></li>
