 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			...
			<div class="addtable">
				<form action="OpnE_saveC" id="saveForm">
					...
					<ul class="maintable">
						...
						<li>
							...
							<div class="maintd">
								...
								<div class="inputtxt">
									请输入合格的课程号（七位纯数字）<a
										href="<%=request.getContextPath()%>/CrsE_listC.action?soMajor=&startDate=&endDate="
					...
					<ul class="maintable">
						<li>
							...
							<div class="maintd">
								...
								<div class="inputtxt">
									请输入合格的教师号（七位纯数字）<a
										href="<%=request.getContextPath()%>/TcrE_listC.action?soTeacher=&startDate=&endDate="
