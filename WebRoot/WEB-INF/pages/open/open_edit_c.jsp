...
<script type="text/javascript">
	$(function() {
		$("#ctrlBack").bind("click", function() {
			window.location.href = "<%=request.getContextPath()%>/OpnE_listC.action?currentPage=1";
						});
 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			<div class="navTittle">
				<h2>开课综合管理—> 开课管理—> 修改开课</h2>
			</div>
			<div class="addtable">
				<form action="OpnE_updateC" id="saveForm">
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.courseID" id="COURSE_ID" maxlength="64" readonly="readonly" class="disinput" value="${open.courseID}"> </span> <span
										class="errs"></span>
								</div>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										...
										class="disinput" readonly="readonly" value="${open.orderID}"> </span> <span
										class="errs"></span>
								</div>
					...
					<ul class="maintable">
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										id="COLLEGE_ID_S" maxlength="64" value="${open.collegeID}"> </span> <span class="errs"></span>
								</div>
								<div class="inputtxt"></div>
							</div>
						</li>
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.collegeID" id="COLLEGE_ID" maxlength="64" value="${open.collegeID}">
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.teacherID" id="TEACHER_ID" maxlength="64" value="${open.teacherID}">
									</span> <span class="errs"></span>
								</div>
								<div class="inputtxt">
									请输入合格的教师号（七位纯数字）<a
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										...
										value="${open.courseType}" > </span> <span class="errs" ></span>
								</div>
								<div class="inputtxt"></div>
							</div>
						</li>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.credit" id="CREDIT" maxlength="64" value="${open.credit}"> </span> <span
										class="errs"></span>
								</div>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										...
										value="${open.periodType}"> </span> <span class="errs"></span>
								</div>
								<div class="inputtxt">请输入大于0，小于1000的纯数字（可小数）</div>
							</div>
						</li>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.period" id="PEROID" maxlength="64" value="${open.period}"> </span> <span
										class="errs"></span>
								</div>
								<div class="inputtxt">请输入大于0，小于1000的纯数字（可小数）</div>
							</div>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.countLimit" id="COUNT_LIMIT" maxlength="64" value="${open.countLimit}"> </span> <span
										class="errs"></span>
								</div>
					...
					<ul class="maintable">
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.tableWeek" id="TABLE_WEEK" maxlength="64" value="${open.tableWeek}">
									</span> <span class="errs"></span>
								</div>
								<div class="inputtxt"></div>
							</div>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.tableDay" id="TABLE_DAY" maxlength="64" value="${open.tableDay}" >
									</span> <span class="errs"></span>
								</div>
								<div class="inputtxt"></div>
							</div>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										name="open.address" id="ADDRESS" maxlength="64" value="${open.address}"> </span> <span
										class="errs"></span>
								</div>
								<div class="inputtxt">不多于20位小写字母、数字或汉字（汉字算两位）组成</div>
							</div>
						</li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="radio"><s:radio
											list="#{'1':'正常','91':'已取消'}" name="open.status"
											theme="simple" value="#{open.status}" /> </span>
								</div>
								<div class="inputtxt"></div>
							</div>
						</li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <textarea name="open.remark"
											id="REMARK" rows="7" cols="32">${open.remark}</textarea> </span> <span
										class="errs"></span>
								</div>
