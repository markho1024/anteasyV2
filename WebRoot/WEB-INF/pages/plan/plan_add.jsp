...
<script type="text/javascript">
	$(function() {
		$("#ctrlBack").bind("click", function() {
			window.location.href = "<%=request.getContextPath()%>/Pln_listAll.action?currentPage=1";
						});
 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			<div class="navTittle">
				<h2>课程综合管理—> 专业授课计划管理—> 增加计划</h2>
			</div>
			<div class="addtable">
				<form action="Pln_save" id="saveForm">
					...
					<ul class="maintable">
						...
						<li>
                            ...
                            <div class="inputtxt">请输入合格的专业号（四位纯数字）<a href="<%=request.getContextPath()%>/Mjr_listAll.action?soMajor=&startDate=&endDate=" target="_blank">查找专业</a></div>
							</div></li>
						...
						<li>
							...
							<div class="maintd">
                                ...
                                <div class="inputtxt">请输入合格的课程号（纯数字）<a href="<%=request.getContextPath()%>/Crs_listAll.action?soMajor=&startDate=&endDate=" target="_blank">查找课程</a></div>
							</div></li>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" id="STUDENT_TYPE"
											maxlength="64" name="plan.studentType">
									</span>
									<span class="errs"></span>
								</div>
							</div></li>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input">
										<textarea name="plan.remark" id="REMARK" rows="7" cols="32"></textarea>
									</span>
								<span class="errs"></span>	
								</div>
