 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			...
			<form action="ScrE_batchSave" id="scoForm">
				<div class="resList">
						...
						<tbody>
							<s:iterator value="pageBean.list" status="st" id="bean">
								...
								<td><a:deep type="courseID|courseName" name="open|course"
										code="#bean.openID" /></td>
								<td><s:hidden name="ids" value="%{#bean.pickID}" />
									<p>
											
                                 <s:if test="open.scoreKind==1">									
										<input type="text" name="scores" width="49" value="<s:property value="#bean.score" />" />
                                 </s:if>
                                 <s:if test="open.scoreKind==2">
										<input type="text" name="scores" id="SCORSES_S" width="49" value="<s:property value="#bean.score" />" />
                                 </s:if>
				...
				<div class="ctrlButton">
					<input type="submit" class="buttons" id="navSubmit" value="提交">
					<input type="button" class="buttonlt" id="rstReset" value="放弃">
				</div>
