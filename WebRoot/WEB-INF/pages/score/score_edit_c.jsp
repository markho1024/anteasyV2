...
<script type="text/javascript">
	$(function() {
		$("#ctrlBack").bind("click", function() {
			window.location.href = "<%=request.getContextPath()%>/ScrE_listC.action?currentPage=1";
						});
 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			...
			<div class="addtable">
				<form action="ScrE_updateC" id="saveForm">
					...
					<ul class="maintable">
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input">
										<textarea name="pick.remark" id="REMARK" rows="7" cols="32">${pick.remark}</textarea>
									</span>
									<span class="errs"></span>
								</div>
