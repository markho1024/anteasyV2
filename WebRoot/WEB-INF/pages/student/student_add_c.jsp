...
<script type="text/javascript">
	$(function() {
		$("#MAJOR_ID_S").combotree({
			url : "./MjrJ_comboP?jsonType=ing&jsonValue="+${loginUser.collegeID},
			editable : false,
			width:164,
			onChange:function(){
 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			...
			<div class="addtable">
				<form action="StdE_saveC" id="saveForm">
					...
					<ul class="maintable">
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.studentType"
											id="STUDENT_TYPE" maxlength="64" value="1">
									</span>
								</div>
							</div>
						</li>
						...
						<li>
							...
							<div class="inputtxt">请输入合格的专业号（4位纯数字）<a href="<%=request.getContextPath()%>/MjrE_listC.action?soMajor=&startDate=&endDate=" target="_blank">查找专业</a></div>
						</li>
						...
						<li>
							...
							<div class="maintd">
								...
								<div class="inputtxt">请输入合格的班级号（10位纯数字）<a href="<%=request.getContextPath()%>/ClzE_listC.action?soClazz=&startDate=&endDate=" target="_blank">查找班级</a></div>
							</div>
						</li>
