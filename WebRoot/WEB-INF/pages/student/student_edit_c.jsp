...
function setMajor(){
    ...
    var urlc= "./MjrJ_comboP?jsonType=&jsonValue="+voc;
   	$("#MAJOR_ID_S").combotree('setValue','');
	$("#MAJOR_ID_S").combotree('reload',urlc);
};
function setClazz(){
    var vom = $("#MAJOR_ID").val();
    var urlm= "./ClzJ_comboP?jsonType=&jsonValue="+vom;
 ...
 <div id="page">
	...
	<div id="context">
		...
		<div id="rightpane" class="right">
			...
			<div class="addtable">
				<form action="StdE_updateC" id="saveForm">
					...
					<ul class="maintable">
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"> <input type="text"
										...
										readonly="readonly"
										class="disinput" value="${student.studentID}"> </span>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.studentName"
											id="STUDENT_NAME" maxlength="64" value="${student.studentName}">
									</span>
									<span class="errs"></span>	
								</div>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.studentTypeID"
											id="STUDENT_TYPE_ID" maxlength="64" value="${student.studentType}">
									</span>
								</div>
							</div>
						</li>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" id="COLLEGE_ID_S"
											maxlength="64" value="${student.collegeID}">
									</span>
								</div>
							</div>
						</li>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" id="MAJOR_ID_S"
											maxlength="64" value="${student.majorID}">
									</span>
							</div>
						</li>
						<li>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" id="CLAZZ_ID_S"
											maxlength="64" value="${student.clazzID}">
									</span>
								</div>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input"><input type="text"
										name="student.createDate" id="CREATE_DATE" maxlength="64" value="${student.createDate}"> </span>
										<span class="errs"></span>	
								</div>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.graSchool" id="GRA_SCHOOL"
											maxlength="64" value="${student.graSchool}">
									</span>
								 <span class="errs"></span>	
								</div>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="radio"><s:radio list="#{'1':'男','0':'女'}"
											name="student.sex" theme="simple" value="student.sex"/>
									</span>
									<span class="errs"></span>	
								</div>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.idCard" id="ID_CARD"
											maxlength="64" value="${student.idCard}">
									</span>
									<span class="errs"></span>	
								</div>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.birthday" id="BIRTHDAY"
											maxlength="64" value="${student.birthday}">
									</span>
									<span class="errs"></span>	
								</div>
								<div class="inputtxt">日期格式为“XXXX-XX-XX”</div>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.nation" id="NATION"
											maxlength="64" value="${student.nation}">
									</span>
									<span class="errs"></span>	
								</div>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.hometown" id="HOMETOWN"
											maxlength="64" value="${student.hometown}">
									</span>
									<span class="errs"></span>	
								</div>
								<div class="inputtxt">2-20位字母、数字或汉字（汉字算一位）组成</div>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.party" id="PARTY"
											maxlength="64" value="${student.party}">
									</span>
								</div>
							</div>
						</li>
								...
								<div class="inputbox">
									<span class="input">
										<input type="text" name="student.jionDate" id="JION_DATE"
											maxlength="64" value="${student.jionDate}">
									</span>
									<span class="errs"></span>	
								</div>
								<div class="inputtxt">日期格式为“XXXX-XX-XX”</div>
					...
					<ul class="maintable">
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="radio"><s:radio
											list="#{'1':'正常','96':'已退学'}" name="student.status"
											theme="simple" value="#{student.status}" /> </span>
								</div>
								<div class="inputtxt"></div>
							</div>
						</li>
						...
						<li>
							...
							<div class="maintd">
								<div class="inputbox">
									<span class="input">
										<textarea name="student.remark" id="REMARK" rows="7" cols="32">${student.remark}</textarea>
									</span>
									<span class="errs"></span>	
								</div>
